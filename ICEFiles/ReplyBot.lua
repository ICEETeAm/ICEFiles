...
if not DevIce:get(ICE..'Ice:Lock:Reply'..msg.chat_id_) then
...
elseif IceConstructor(msg.sender_user_id_, msg.chat_id_) then
...
ICETeAm =  "آخلُِآقٌڪڪ لُِڪڪ 𖠙 😒🔪"
Dev_Ice(msg.chat_id_, msg.id_, 1, ICETeAm, 1, 'md') 
return false
end
if text == 'السلام عليكم' or text == 'سلام عليكم' then 
ICETeAm =  "ياھَہّلْاا ۅﻋ̝̚لْيڪْم الْﺳ̭͠ لْام 𖠙 🤤♥️"
Dev_Ice(msg.chat_id_, msg.id_, 1, ICETeAm, 1, 'md') 
return false
end
if text == '😭💔' or text == '😭😭' or text == '😭😭😭' or text == '😿💔' or text == '😭😭😭' or text == '😭😭😭😭' then 
ICETeAm =  "مآآعٍآشُ آلُِي يزعٍلُِڪڪ 𖠙 😏♥️"
Dev_Ice(msg.chat_id_, msg.id_, 1, ICETeAm, 1, 'md') 
return false
end
if text == '🌚💔' or text == '💔🌚' or text == '🚶‍♂💔' or text == '💔' or text == '😔💔' or text == '🚶‍♀💔' or text == '😭' then 
ICETeAm =  "شبّيي اﻟ̣̣פﻟ̣̣و 𖠙 😿💔"
Dev_Ice(msg.chat_id_, msg.id_, 1, ICETeAm, 1, 'md') 
return false
end
if text == 'باي' or text == 'بااي' or text == 'اروح' or text == 'اروح احسن' or text == 'اولي احسن' or text == 'راح اروح' or text == 'باي انام' then 
ICETeAm =  "أُرٌجُعُ عٍيدِهآآ مٍوو تنِْسةه 𖠙 🤤♥️"
Dev_Ice(msg.chat_id_, msg.id_, 1, ICETeAm, 1, 'md') 
return false
end
if text == 'هلو' or text == 'هلاو' or text == 'هلا' or text == 'هلاوو' or text == 'هيلاو' or text == 'هيلاوو' or text == 'هلاا' then 
local ICETeAm = {"اࠗط็لق֯ق֯ هٞللاࠗ୨و 𖠙 🤤♥️" ,"هۂَلاا نۨہٰورتت يعمۘري 𖠙 🤤♥️" } 
DevIce2 = math.random(#ICETeAm) 
Dev_Ice(msg.chat_id_, msg.id_, 1, ICETeAm[DevIce2] , 1, 'md') 
return false
end
if text == 'سورس' or text == 'السورس' or text == 'سورس' or text == 'السورس' or text == 'سورس منو' or text == 'سورسك' or text == 'سورس البوت' then 
local ICETeAm = {"سورس خالتك" } 
DevIce2 = math.random(#ICETeAm) 
Dev_Ice(msg.chat_id_, msg.id_, 1, ICETeAm[DevIce2] , 1, 'md') 
return false
end
...
local ICETeAm = {"ماﺷ͠ يةھَہّ يﻋ̝̚مريي ۅاﻧﺗ̲ت 𖠙 🤤♥️" ,"الحۡمۘدللهۂَ ٰوانۨہتت 𖠙 🤤♥️","تمۘامۘ عمۘري ٰوانۨہتت 𖠙 🤤♥️"} 
DevIce2 = math.random(#ICETeAm) 
Dev_Ice(msg.chat_id_, msg.id_, 1, ICETeAm[DevIce2] , 1, 'md') 
return false
end
if text == 'وينك' or text == 'وينج' then
ICETeAm =  "مْوٌجہوٌدِ يہمْگُ يحلوُ 𖠙 😉♥️"
Dev_Ice(msg.chat_id_, msg.id_, 1, ICETeAm, 1, 'md') 
return false
end
...
ICETeAm =  "طُآمسين ووعٍيوونڪ 𖠙 😪🖤ۦ"
Dev_Ice(msg.chat_id_, msg.id_, 1, ICETeAm, 1, 'md') 
return false
end
if text == 'هلوباي' or text == 'هلو باي' then  
ICETeAm =  "شحۡسۜيت مۘنۨہ هيجۚ ּكتبت ؟ 🌝♥️"
Dev_Ice(msg.chat_id_, msg.id_, 1, ICETeAm, 1, 'md') 
return false
end
if text == 'اكلك' or text == 'اكلج' or text == 'اكلكم' then 
ICETeAm =  "ڪوولُِ مآڪوولُِ لُِآحٍدِ 𖠙 😉♥️"
Dev_Ice(msg.chat_id_, msg.id_, 1, ICETeAm, 1, 'md')
return false
end
if text == 'فرخ' then
ICETeAm =  "ٰوينۨہهۂَ خۡل احۡصرهۂَ 𖠙 😹♥️" 
Dev_Ice(msg.chat_id_, msg.id_, 1, ICETeAm, 1, 'md') 
return false
end
if text == 'سورس عبس' or text == 'سورس شبح' or text == 'سورس ديف شبح' or text == 'سورس زربه' or text == 'السورس زربه' or text == 'سورس عاوي' or text == 'السورس عاوي' then 
ICETeAm =  "لُِآ سوورس خآلُِتڪ دِي لُِڪ 𖠙 😒🔪" 
Dev_Ice(msg.chat_id_, msg.id_, 1, ICETeAm, 1, 'md')
return false
end
end
...
DevIce:del(ICE..'Ice:Lock:Reply'..msg.chat_id_)
end end
if text == 'تعطيل ردود البوت' or text == 'تعطيل الردود' then
if DevIce:get(ICE..'Ice:Lock:Reply'..msg.chat_id_) then
Dev_Ice(msg.chat_id_, msg.id_, 1, '⌁︙ردود البوت بالتاكيد معطله ', 1, 'md')
else
DevIce:set(ICE..'Ice:Lock:Reply'..msg.chat_id_,true)
